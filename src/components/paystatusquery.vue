...
title: '业务类型',
key: 'business_type'
},{title:'用户key',key:'user_key'},{title:'快捷支付状态',key:'quick_pay_status'},{title:'消息',key:'message'},{
    title: '操作',
    key: 'action',
    width: 350,
    align: 'center',
...
title: '业务类型',
key: 'business_type'
},{title:'代付状态',key:'pay_status'},{title:'消息',key:'message'},{
    title: '操作',
    key: 'action',
    width: 350,
    align: 'center',
...
title: '业务类型',
key: 'business_type'
},{title:'代扣状态',key:'gather_status'},{title:'消息',key:'message'},{
    title: '操作',
    key: 'action',
    width: 350,
    align: 'center',
...
var statusname=''
  ...
  var sql = {"sql":"update "+table+" set "+statusname+"='"+modifystatus+"' , message='手动修改状态为"+modifystatus+"'  where business_order_id = '"+params.row.business_order_id+"'"}
...
var sql = {"sql":"select * from user_quick_pay_info where business_order_id = '"+this.proxyserialno1+"'"}
...
var sql = {"sql":"select * from user_pay_info where business_order_id = '"+this.proxyserialno2+"'"}
...
var sql = {"sql":"select * from user_gather_info where business_order_id = '"+this.proxyserialno3+"'"}
